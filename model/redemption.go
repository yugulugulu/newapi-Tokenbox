...
func Redeem(key string, userId int) (quota int, err error) {
	...
	RecordTopupLog(userId, redemption.Quota, TopupSourceRedemption, fmt.Sprintf("通过兑换码充值 %s，兑换码ID %d", logger.LogQuota(redemption.Quota), redemption.Id), "", "redemption", "redemption")
