...
type ImageResolutionLimit string

const (
	ImageResolutionLimitUnlimited ImageResolutionLimit = "unlimited"
	ImageResolutionLimit1K        ImageResolutionLimit = "1k"
	ImageResolutionLimit2K        ImageResolutionLimit = "2k"
	ImageResolutionLimit4K        ImageResolutionLimit = "4k"
)
...
type ChannelOtherSettings struct {
	...
	ImageResolutionLimit                  ImageResolutionLimit  `json:"image_resolution_limit,omitempty"`     // gpt-image-2 渠道图片分辨率上限
